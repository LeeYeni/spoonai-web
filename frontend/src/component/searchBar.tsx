  ...
  return (
    <section className="flex flex-col items-center justify-center py-20 px-4 w-full bg-linear-to-b from-orange-50/50 to-white">
      <div className="max-w-3xl w-full text-center space-y-6">
        {/* 타이틀 영역 */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-black text-gray-900 tracking-tight">
          오늘 당신의 <span className="text-orange-500">취향</span>은 무엇인가요?
        </h2>
        <p className="text-gray-500 text-base sm:text-lg md:text-lg lg:text-lg font-medium">
