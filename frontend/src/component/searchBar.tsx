      ...
      <div className="max-w-3xl w-full text-center space-y-6">
        ...
        <div className="relative mt-8 group">
          <input
            ...
            placeholder="먹고 싶은 메뉴나 분위기를 입력해 보세요..."
            className="w-full px-8 py-5 text-lg rounded-full border-2 border-gray-100 bg-white shadow-xl focus:border-orange-500 focus:outline-none transition-all duration-300 group-hover:shadow-2xl"
          />
          <button
